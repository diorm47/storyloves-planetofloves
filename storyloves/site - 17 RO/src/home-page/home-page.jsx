                  ...
                  <div className="pure-u header__right">
                    <div className="menu">
                      ...
                      <a
                        ...
                        data-svg="location"
                      >
                        <span>Persoane din apropiere</span>
                ...
                <div className="pure-g">
                  <div className="pure-u-1 pure-u-md-1-3 pure-u-xl-1-4">
                    <div className="user site-bar">
                      <div className="user__info">
                        <div className="user__photo js_add_photo">
                          <div
                            className="user__photo--lock hidden tooltipstered svgEl"
                            data-svg="lock"
                            data-tooltip="tooltip-top"
                            data-content="Poze private"
                          >
                            <svg className="svg__lock">
                        ...
                        <span className="coins_bl">0</span>
                    </a> */}
                          </div>
                          <a
                            href="/user/profile"
                      ...
                      <div className="user__links">
                        <a href="/id287833391" className="user__link">
                    ...
                    <div className="premium site-bar">
                      ...
                      <div
                        className="premium__img svgEl"
                        data-svg="premium-img_v2"
                      >
                        <svg className="svg__premium-img_v2">
                          <use href="#svg__premium-img_v2"></use>
                        </svg>
                      </div>
                      <div className="premium__text">
                        Un cont premium îți permite să te bucuri de toate
                        caracteristicile de pe StoryLoves. Familiarizează-te,
                        vizualizează fotografii, povestește și întâlnește
                        persoane noi!
                      </div>
                      <a
                        href="/premium"
                        onClick="ym(56503840,'reachGoal','getpremium_banner')"
                        className="premium__button button"
                      >
                        <span>Obține Premium</span>
                      </a>
                    </div>
                  </div>
                    ...
                    <div className="content">
                      ...
                      <div className="content__box">
                          ...
                          <div className="pure-u-1-2 pure-u-sm-1-3 pure-u-md-1-2 pure-u-xl-1-3 people__box">
                            <div className="people__item">
                              <div className="people__photo">
                                ...
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/9c91af66ac38d400880dc1d4c4fbdfba/a6278a3012db37329d50944c5af7653d/b4520d045b5d3ccf22182b24ed9ef2eb.jpg" />
                                  ...
                                  <div className="people__info">
                                    ...
                                    <div
                                      className="people__location svgEl"
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    ...
                                    data-user="57fca35fcf1e8c533c3eeb0f"
                                  >
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/4d2abac1941415717bedaa33434d5843/c4a72693d31444bae87c30e021de125a/a2c30304036620c98412f6971fcbb4e5.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca31fcf1e8c533c3eea16"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/f26a2638d7bfbab883a5f8d35dd9f556/13977b0ab89f65edf134a64e775a3f6d/360a07f63858bd89937eac9981c82222.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca33ccf1e8c533c3eea73"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/86ede07479e8d777c2e3d94615b372b0/0727005de301fbfdcbf9364109917be2/bea9630fe4832a0c2a2ac9146e280d5d.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca381cf1e8c533c3eeb8b"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/86ede07479e8d777c2e3d94615b372b0/72a8d884903c697f72dceeaaf03ec510/69e638392b183eec25cf8b0f2dd49405.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca360cf1e8c533c3eeb11"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/db43f9b507d251b1868874f51a4c5065/c739f65619f06bba04b3bee4edc53f04/fc9551da09c24ce5dfc855f49f56c36c.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca3c8cf1e8c533c3eec65"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/ce539e776d9122d1dd5fe991b94ed56e/8893ddf4a4f7094446249ee93ce7293d/f406181b9c31e2eb4b91c6590c719575/2ccdebd93d16a7ef3cf9454c52389b2d.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="635a4d45ddaa2e66f6161603"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/f07f4109b673750fdb644d2f2f0af8e7/dcda97940ffef7800b9cafcd8c730658/a4ebb77093281db19c1bee2ac2df1281.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca3f7cf1e8c533c3eed12"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/5b0c33376fe218fc086124236d0ad7f9/3b85c18bc3c3339e3bade790fe5f5d9d/4ec84f948f497051480a539db5fb3e49.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca2f5cf1e8c533c3ee94f"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/ce539e776d9122d1dd5fe991b94ed56e/233fb00897f1dfc87d0b2cd537e52d1f/85dceb4c181d8befb43c57acda6f68dc/adb84bfd8a36fbc9ef538a48af032c8a.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="635a4d45ddaa2e66f616154f"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/885e7e987fa29ec7add563d1f7b5645c/85141a75bc2fa3712eed2ffacb6e7d31/a0f00f0f2dd1eaf306cbdfa88b4e0825.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca344cf1e8c533c3eeaab"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/24438076fded6ce61542a8a54b0b4d9a/a448dedb601255ae273ca6dc5e5a58a9/fdc76813182db15845154692c2c2e762.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca405cf1e8c533c3eed40"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/ae8f1432c838e8f8ddb720d40e7c7b4b/b810caba8c20df8851ac52e5f4490e77/3ca24c93be63ad446954f946e5f337b3.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca3c1cf1e8c533c3eec53"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/86ede07479e8d777c2e3d94615b372b0/4feda06dca04255b1641c123b04ba087/eb2f1b5a1316284e7af3115c105bcd36.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca308cf1e8c533c3ee9a1"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/323fe015951cef7085a66a7107b325b7/aeb1127ee2f42200e5b33ed1b22263d4/b8bfa8c3eb4333d4f11ceb61c5b3f8f8.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca356cf1e8c533c3eeaf2"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/df16fb02d4108aa3e51427d9b8053c0b/570613e09f635cbc321e6739797c85d4/ae43148cc1c512ff2d71e73848ae2a35.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca2cfcf1e8c533c3ee884"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/1ce095d26ebfe394b104b21d2f9b85eb/3326315d9006e311ab8269e4eddb0677/a9ff970b4f47158f1af77ef424b5711f.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca37fcf1e8c533c3eeb7a"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/0318e9e55f3815ab6a1f31555e2fcecf/ba219ec97f9245e1e87ab5c401d30250/8fa27bbec9711124aeaf3e4949678cb8.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca391cf1e8c533c3eebb6"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/dc4f1fefefa4be8dba4e9fa39a93159e/bc13d6827556475c3f2d8dd8d2c609ca/1b1d82b542b41190845d8fbf73e8de6b.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca312cf1e8c533c3ee9d6"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/1ca59c128e5d5d3f1294f64bd3df78d9/a54b0606a98fb96d454fcaa1b9cc66ba/d1ec853834e1122975298aa8d0d654bd.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca2c2cf1e8c533c3ee85a"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/608c6779802dd23e0e0a186a9989ca1c/7afde97f8eb80104b432ca0435c2f44b/1b61a7f8aaf12d3c4ff1a8c6f6769925.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca342cf1e8c533c3eea9f"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/608c6779802dd23e0e0a186a9989ca1c/0dc99b43a7d4ee919ec5a83b5972aa31/c9060d3ae6c91acf5545a7774b592689.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca3dccf1e8c533c3eecc3"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/195bae3b08133035d604581b24f2b794/f799c6e69f994f6d238d7025bc5c0bad/f64d8a2b4d60619a358b01639386cafe.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca2c1cf1e8c533c3ee850"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                            ...
                            <div className="people__item">
                              <div className="people__photo">
                                <a
                                  ...
                                  className="people__photo--link"
                                >
                                  <img src="//media.storyloves.net/photos/095c0b9ec373318287f6edd0168f01ab/56352829a10f14f390c42e2e92ea1939/a6886f8df821ba7461a05fcc46a9927a/00c884004a83da069e7626cd6efe31d0.jpg" />
                              ...
                              <div className="people__links">
                                ...
                                <div className="people__link">
                                  <div
                                    className="people__link--item people__link--like js_favorites svgEl"
                                    data-svg="like:before#like-on:before"
                                    data-user="57fca319cf1e8c533c3ee9f7"
                                  >
                                    <svg className="svg__like-on">
                                      <use href="#svg__like-on"></use>
                                    </svg>
                        ...
                        <div className="pagination">
                          ...
                          <a href="/nearby?page=2" className="pagination__item">
                            2
                          </a>

                          <a href="/nearby?page=3" className="pagination__item">
                            3
                          </a>
              ...
              <div className="pure-c">
                  ...
                  <div className="pure-u-1  pure-u-md-5-7 pure-u-lg-5-6 ">
                    <div className="footer__menu">
                      <div className="footer__list">
                        <a href="/terms">Condiţii de utilizare</a>
                      </div>
                      <div className="footer__list">
                        <a href="/policy">Confidențialitate</a>
                      </div>

                      <div className="footer__list">
                        <a href="/payments">Plată</a>
                      </div>

                      <div className="footer__list">
                        <a href="/contacts">Date de contact</a>
                      </div>
                      <div className="footer__list">
                        <a href="/about">Despre noi</a>
                      </div>
                      <div className="footer__list">
                        <a href="/imprint">Marca înregistrată</a>
                      </div>
                      <div className="footer__list">
                        <a href="/help">Suport clienți</a>
                      </div>
                    </div>
                  </div>
                ...
                <div className="footer__table">
                  <div className="footer__copyright">
                    Drepturi de autor © StoryLoves 2023
                  </div>
