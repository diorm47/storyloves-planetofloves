    ...
    <div className="modal_wrapper">
      <div className="modal_block">
        <div className="modal_title">
          <h1>Înscrie-te pentru a începe să cunoști oameni!</h1>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="name_input">
            <div className="genders_toggles">
              <div className="my_gender_iden">
                ...
                <div className="error_gender">
                  {myGenderError ? <p>Selectează-ți sexul</p> : ""}
                </div>
              </div>
              <div className="seeking_gender_iden">
                ...
                <div className="error_gender">
                  {seekingGenderError ? <p>Selectați genul de căutare</p> : ""}
                </div>
              </div>
            </div>
            ...
            />
            {errors.name && <span>* Numele de utilizator este necesar</span>}
          </div>
          ...
          <div className="email_sign">
            ...
            />
            {errors.email && <span>* E-mailul este obligatoriu</span>}
            {emailError === 1 ? (
