    ...
    <div className="modal_wrapper">
      <div className="modal_block">
        <div className="modal_title">
          <h1>Zarejestruj się, aby zacząć poznawać ludzi!</h1>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="name_input">
            <div className="genders_toggles">
              <div className="my_gender_iden">
                ...
                <div className="error_gender">
                  {myGenderError ? <p>Wybierz płeć</p> : ""}
                </div>
              </div>
              <div className="seeking_gender_iden">
                ...
                <div className="error_gender">
                  {seekingGenderError ? <p>Wybierz typ wyszukiwania</p> : ""}
                </div>
              </div>
            </div>
            ...
            />
            {errors.name && <span>* Wymagana jest nazwa użytkownika</span>}
          </div>
          ...
          <div className="location_input">
            {needCityId ? (
              <>
                ...
                {locationError ? <span>* Lokalizacja jest wymagana</span> : ""}
              </>
            ) : (
              <>
          ...
          <div className="email_sign">
            ...
            {emailError === 1 ? (
              <span>Adres e-mail już istnieje lub jest nieprawidłowy</span>
            ) : (
              ""
            )}
          </div>
