    ...
    <div className="modal_wrapper">
      <div className="modal_block">
        <div className="modal_title">
          <h1>Iscriviti per iniziare a incontrare persone!</h1>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="name_input">
            <div className="genders_toggles">
              <div className="my_gender_iden">
                ...
                <div className="error_gender">
                  {myGenderError ? <p>Selezionare genere</p> : ""}
                </div>
              </div>
              <div className="seeking_gender_iden">
                ...
                <div className="error_gender">
                  {seekingGenderError ? (
                    <p>Seleziona un tipo di ricerca</p>
                  ) : (
                    ""
                  )}
                </div>
            ...
            />
            {errors.name && <span>* è richiesto il nome utente</span>}
          </div>
          ...
          <div className="location_input">
            {needCityId ? (
              <>
                ...
                {locationError ? <span>* posizione richiesta</span> : ""}
              </>
            ) : (
              <>
          ...
          <div className="email_sign">
            ...
            />
            {errors.email && <span>* è richiesta la posta elettronica</span>}
            {emailError === 1 ? (
              <span>L'indirizzo e-mail esiste già o non è valido</span>
            ) : (
              ""
            )}
          </div>
          <div className="password_sign">
            ...
            />
            {errors.password && (
              <span>* La password deve essere di almeno 6 caratteri</span>
            )}
          </div>
